...
public class MyAdapter extends ArrayAdapter<Action> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(convertView == null){
            //// TODO: 03/05/2017 inflate R.layout.list_item to view object - convertView
        ...
        //inflate is a metoda of the class LyoutInflator and with it you can change a xml file to a view object.
        return convertView;
    }
}
